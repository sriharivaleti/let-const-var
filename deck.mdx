...
<div style={{width: "90%"}}>
    ...
    <ol>
        ...
        <li><strong><em>Basically</em></strong>, when <code style={{color: "#cc0487"}}>naming variables</code>, the names should start with either an <code style={{color: "#cc0487"}}>alpha character</code> (alphabetical), an underscore <code style={{color: "#cc0487"}}>_</code>, or a <code style={{color: "#cc0487"}}>$</code>. You will never go wrong if you follow this rule!</li>
    </ol>
</div>
...
<div style={{width: "90%"}}>
    ...
    <ul>
        ...
        <li>
            <a href="https://www.w3schools.com/js/js_hoisting.asp">JavaScript Hoisting</a>: <strong>W3Schools</strong>
        </li>
    </ul>
</div>